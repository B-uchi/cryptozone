...
const NewsItem: React.FC<NewsItemProps> = (props) => {
  ...
  return (
    <div className="p-3 gap-3 flex-grow rounded-md h-[200px] bg-white dark:bg-[#12131f] flex items-center justify-center border-[1px] border-[#efefef] dark:border-[#171717]">
